                      ...
                      <div className="aspect-[2/3] relative">
                        ...
                        <div className="absolute top-2 right-2 space-y-1 opacity-0 group-hover:opacity-100 transition-all duration-200">
                          <button
                            ...
                            className="block w-8 h-8 bg-white rounded-md flex items-center justify-center text-gray-600 hover:bg-gray-100 transition-colors cursor-pointer shadow-lg"
                          >
                          ...
                          <button
                            ...
                            className="block w-8 h-8 bg-white rounded-md flex items-center justify-center text-red-600 hover:bg-red-50 transition-colors cursor-pointer shadow-lg"
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
